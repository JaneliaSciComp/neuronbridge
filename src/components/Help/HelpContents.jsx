  ...
  return (
    <div ref={helpContentRef} className="helpcontents">
      ...
      <p>
        ...
        used to locate an EM body id or cell line of interest. By default, the search looks for an exact match 
        to the input string, and you can add wildcards for a wider search. 
        For example, if you were looking for the cell line LH173, searching for &ldquo;LH173&rdquo; would find 
        exactly one result for that cell line:
      </p>
      ...
      <p>
        If you were interested in all the cell lines from our 2014
        mushroom body paper, then you could search with a wild card like this:
      </p>
      ...
      <p>
        Note wild card searches are limited to the first 100 matches.
        To see additional entries, enter a more specific search term, for example:
      </p>
      ...
      <p>
        This initial search will show all the relevant images that have precomputed results. 
        Clicking on a &ldquo;Results&rdquo; button next to a given image takes you to the matches for that image.
      </p>
      ...
      <p>
        ...
        neuron body from the FlyEM Project, sorted from highest to
        lowest scoring.
      </p>
      ...
      <p>
        The matches for light microscopy (LM) images show a grid of images related to a cell
        line from one of our <Link to="/about">papers</Link>. They are 
        sorted from highest to lowest scoring, but all matching images for a line
        are sorted together with the highest scoring image in that line. By
        default, we display a single image per line, but this can be adjusted by
        clicking on the &ldquo;Filters / Sorting&rdquo; button and then changing the 
        value of the &ldquo;results per line&rdquo; textbox:
      </p>
      ...
      <Row gutter={24}>
        ...
        <Col lg={12}>
          <p>
            Raw light microscopy (LM) data collected by FlyLight is transformed in several ways prior to matching
            using color depth MIP search (<a href="https://doi.org/10.1101/318006">Otsuna et al., 2018</a>). 
            To improve matches for denser MCFO data, the color depth MIP approach was extended in several
            ways (Otsuna, et al., in preparation). The data generation pipeline for LM images is shown on the left. 
          </p>
          <p>
            After images are aligned to a common template, we used direction selective 
            local thresholding (DSLT;{" "}
          ...
          <p>
            Note that the counts in the diagram are provided only to give a sense of the
            relative cardinality and do not represent all of the data currently in NeuronBridge.
          </p>
          <p>
            A preprint including more details is <a href="https://doi.org/10.1101/2022.07.20.500311">available on bioRxiv</a>.
          </p>
        </Col>
        ...
        <Col lg={12} className="top-space">
          <p>
            The EM data sets were imaged and reconstructed by the FlyEM Project (
            <a href="https://www.biorxiv.org/content/10.1101/2020.01.21.911859v1">
              Xu, et al., 2020
            </a>). After the imagery was registered to the JRC2018 template, we
      ...
      <Row>
        ...
        <Col lg={12}>
          <p>
            Pre-generated CDM matches were computed as a cartesian product of the
          ...
          <p>
            This method will be more fully described by Otsuna, et al., in preparation. 
            The pseudocode below is provided as a high level summary.  For each hemibrain body:
          </p>
          <ol>
            <li>Compare to every LM color depth MIP to find the number of matching pixels</li>
            <li>Compute match percentage by dividing number of matching pixels by the mask size</li>
            <li>Eliminate all matches with less than 1% match percentage</li>
            <li>Sort results by matching pixels and select the top 300 lines</li>
            <li>Select all of the MIPs in the top 300 lines</li>
            <li>Calculate normalized scores based on gradient scoring algorithm</li>
        ...
        <Col lg={12}>
          <p>
            ...
            “negative” match scores were computed based on signal outside the mask.
      ...
      When you upload an unaligned image stack to the NeuronBridge, 
      it is automatically registered to a standard color depth search alignment template. Currently, these are
      JRC2018_Unisex_20x_HR (Brain) and JRC2018_VNC_Unisex_40x_DS (VNC) both of which are derived from the
      <a href="https://www.janelia.org/open-science/jrc-2018-brain-templates">JRC 2018 templates</a>.
      ...
      <dl>
        ...
        <dd>
          The uploaded file must have a reference channel (nc82 or chemical tag which stains the neuropil.)
        </dd>
        ...
        <dd>
          This is unrecoverable in our system. You will need to use an alternative method to 
          register your data. Once you have an aligned image stack, use the{" "}
          <a href="https://github.com/JaneliaSciComp/ColorMIP_Mask_Search">Color MIP Mask Search Fiji plugin</a>{" "}
          to generate the aligned color depth MIPs and upload those for custom searching.
        </dd>
      </dl>
    </div>
  );
